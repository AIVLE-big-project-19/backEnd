...
서비스는 원활한 업무 처리를 위해 다음과 같이 개인정보 처리업무를 외부에 위탁하고 있습니다. 위탁계약 체결 시에는 개인정보 보호법에 따라 위탁업무 수행 목적 외 개인정보 처리 금지, 기술적·관리적 보호조치, 재위탁 제한 등을 명시하고 수탁자가 개인정보를 안전하게 처리하는지 감독합니다.

| 수탁업체 | 위탁업무 내용 |
|---|---|
| Amazon Web Services(AWS) | 서비스 서버 호스팅 및 운영 |
| 이메일 발송대행사 | 회원가입/비밀번호 재설정 인증코드 및 문의 답변 메일 발송 |
...
- 개인정보 보호책임자: 한승연
- 연락처: 010-7374-5589
- 개인정보 관련 문의는 위 연락처 또는 서비스 내 문의하기 기능을 이용해 주시기 바랍니다.
