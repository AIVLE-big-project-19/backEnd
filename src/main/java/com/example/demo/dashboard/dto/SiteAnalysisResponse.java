...
public record SiteAnalysisResponse(
        Long id, String address, String siteType, Double latitude, Double longitude, Double areaM2, Double capacityKw,
    ...
    public static SiteAnalysisResponse from(SiteAnalysis analysis) {
        ...
        return new SiteAnalysisResponse(
                analysis.getId(), analysis.getAddress(), analysis.getSiteType() == null ? "LAND" : analysis.getSiteType(), analysis.getLatitude(), analysis.getLongitude(),
